...
public final class SimpleExtensionToSqlOperator {
  ...
  private static SqlFunction toSqlFunction(
    ...
    if (function instanceof SimpleExtension.AggregateFunctionVariant) {
      return toSqlAggregateFunction(function, typeFactory, typeConverter);
    }

    if (function instanceof SimpleExtension.WindowFunctionVariant) {
      return toSqlWindowFunction(function, typeFactory, typeConverter);
    }

    return toSqlScalarFunction(function, typeFactory, typeConverter);
  }

  private static SqlFunction toSqlAggregateFunction(
      SimpleExtension.Function function,
      RelDataTypeFactory typeFactory,
      TypeConverter typeConverter) {
  ...
  private static SqlFunction toSqlWindowFunction(
      SimpleExtension.Function function,
      RelDataTypeFactory typeFactory,
      TypeConverter typeConverter) {
  ...
  private static SqlFunction toSqlScalarFunction(
      SimpleExtension.Function function,
      RelDataTypeFactory typeFactory,
      TypeConverter typeConverter) {
