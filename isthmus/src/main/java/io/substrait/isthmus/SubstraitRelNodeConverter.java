...
public class SubstraitRelNodeConverter
  ...
  private RelBuilder getRelBuilder(Set set) {
    ...
    switch (set.getSetOp()) {
      case SetOp.MINUS_PRIMARY:
        return relBuilder.minus(false, numInputs);
      case SetOp.MINUS_PRIMARY_ALL:
      case SetOp.MINUS_MULTISET:
        return relBuilder.minus(true, numInputs);
      case SetOp.INTERSECTION_PRIMARY:
      case SetOp.INTERSECTION_MULTISET:
        return relBuilder.intersect(false, numInputs);
      case SetOp.INTERSECTION_MULTISET_ALL:
        return relBuilder.intersect(true, numInputs);
      case SetOp.UNION_DISTINCT:
      ...
      default:
        throw new UnsupportedOperationException("Unsupported set operation: " + op);
    }
  }
